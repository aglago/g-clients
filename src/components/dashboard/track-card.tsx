...
export default function Trackcard({
  ...
  // Truncate description to ensure consistent heights
  const truncatedDescription = track.description.length > 80 
    ? track.description.substring(0, 80) + "..." 
    : track.description;

  return (
    <Card
      className="rounded-[20px] shadow-sm overflow-hidden px-0 pt-0 gap-4 h-[420px] flex flex-col"
    >
      <div className="flex flex-col h-full">
        {/* Image and Price - Fixed height */}
        <div
