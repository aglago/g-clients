          ...
          <div className="space-y-12">
            {Array.from({ length: 2 }).map((_, i) => (
              <div key={i} className="space-y-6">
                ...
                <div className="h-6 bg-gray-200 rounded w-1/3 animate-pulse border-b border-gray-200 pb-2"></div>
                
                {/* Course Cards Skeleton */}
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  {Array.from({ length: 4 }).map((_, j) => (
                    <Card key={j} className="shadow-lg overflow-hidden animate-pulse">
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <div className="flex gap-1">
                        {[1, 2, 3, 4, 5].map((star) => (
                          <div key={star} className="w-8 h-8 bg-gray-200 rounded"></div>
                        ))}
                      </div>
                    </div>
                    <div>
                      <div className="h-4 bg-gray-200 rounded w-80 mb-1"></div>
